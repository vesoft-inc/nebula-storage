...
#ifndef STORAGE_EXEC_STATPROCESSOR_H_
#define STORAGE_EXEC_STATPROCESSOR_H_
...
// StatProcessor will only be used in GetNeighbors for now, it need to calculate some stat of all
...
#endif  // STORAGE_EXEC_STATPROCESSOR_H_
