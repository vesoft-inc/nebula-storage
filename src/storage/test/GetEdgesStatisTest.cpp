...
cpp2::GetEdgesStatisRequest
buildGetEdgesStatisRequest(int32_t parts, IndexID indexId) {
    cpp2::GetEdgesStatisRequest req;
    req.space_id = 1;
...
TEST(GetEdgesStatisTest, SimpleTest) {
