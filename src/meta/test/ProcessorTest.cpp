...
TEST(ProcessorTest, SpaceTest) {
    ...
    }
    {
        ...
        ASSERT_EQ(nebula::cpp2::ErrorCode::SUCCEEDED, resp1.code);
    }
    // Test default value
    {
        cpp2::SpaceProperties properties;
        ...
        ASSERT_EQ(nebula::cpp2::ErrorCode::SUCCEEDED, cresp.code);
        ...
        ASSERT_EQ(nebula::cpp2::ErrorCode::SUCCEEDED, gresp.code);
        ...
        ASSERT_EQ(nebula::cpp2::ErrorCode::SUCCEEDED, dresp.code);
    }
}
...
TEST(ProcessorTest, CreateTagTest) {
    ...
    schema.set_columns(std::move(cols));
    {
        ...
        processor->process(req);
        auto resp = std::move(f).get();
        ASSERT_EQ(nebula::cpp2::ErrorCode::E_SPACE_NOT_FOUND, resp.code);
    }
    {
        // Succeeded
        cpp2::CreateTagReq req;
    ...
    }
    {
        ...
        processor->process(req);
        auto resp = std::move(f).get();
        ASSERT_EQ(nebula::cpp2::ErrorCode::E_TAG_EXISTED, resp.code);
    }
    {
    ...
    }
    {
        ...
        processor->process(req);
        auto resp = std::move(f).get();
        ASSERT_EQ(nebula::cpp2::ErrorCode::E_CONFLICT, resp.code);
    }
    {
    ...
    }
    {
        ...
        ASSERT_EQ(nebula::cpp2::ErrorCode::SUCCEEDED, getResp.code);
...
TEST(ProcessorTest, CreateEdgeTest) {
   ...
   }
   {
    ...
    }
    {
        ...
        processor->process(req);
        auto resp = std::move(f).get();
        ASSERT_EQ(nebula::cpp2::ErrorCode::E_EDGE_EXISTED, resp.code);
    }
    {
...
TEST(ProcessorTest, AlterTagTest) {
    ...
    // Verify ErrorCode of add
    {
        ...
        processor->process(req);
        auto resp = std::move(f).get();
        ASSERT_EQ(nebula::cpp2::ErrorCode::E_PROP_EXISTED, resp.get_code());
    }
    // Verify ErrorCode of change
    {
        ...
        processor->process(req);
        auto resp = std::move(f).get();
        ASSERT_EQ(nebula::cpp2::ErrorCode::E_PROP_NOT_FOUND, resp.get_code());
    }
...
TEST(ProcessorTest, TagIndexTest) {
    ...
    }
    {
        ...
        processor->process(req);
        auto resp = std::move(f).get();
        ASSERT_EQ(nebula::cpp2::ErrorCode::E_INDEX_EXISTED, resp.get_code());
    }
    {
        cpp2::CreateTagIndexReq req;
        req.set_space_id(1);
