...
void StatisJobExecutor::addStatis(cpp2::StatisItem& lhs, const cpp2::StatisItem& rhs) {
    ...
    lhs.positive_part_corelativity.insert(rhs.positive_part_corelativity.begin(),
                                          rhs.positive_part_corelativity.end());
    lhs.negative_part_corelativity.insert(rhs.negative_part_corelativity.begin(),
                                          rhs.negative_part_corelativity.end());
}
