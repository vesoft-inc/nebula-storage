...
// career average score, served teams, country
std::vector<Player> MockData::players_ = {
    {"Tim Duncan",            44,  false,  19,  1997,  2016,  1392,  19.0,  1,  "America"  },
    {"Tony Parker",           38,  false,  18,  2001,  2019,  1254,  15.5,  2,  "France"   },
    {"LaMarcus Aldridge",     35,  true,   14,  2006,  2020,  1003,  19.5,  2,  "America"  },
    {"Rudy Gay",              34,  true,   14,  2006,  2020,   939,  17.1,  4,  "America"  },
    {"Marco Belinelli",       34,  true,   13,  2007,  2020,   855,   9.7,  9,  "Italy"    },
    {"Danny Green",           33,  true,   11,  2009,  2020,   681,   8.9,  4,  "America"  },
    {"Kyle Anderson",         27,  true,    6,  2014,  2020,   359,   5.4,  2,  "America"  },
    {"Aron Baynes",           34,  true,    8,  2012,  2020,   469,   6.0,  4,  "Australia"},
    {"Boris Diaw",            38,  false,  14,  2003,  2017,  1064,   8.6,  5,  "France"   },
    {"Tiago Splitter",        36,  false,   7,  2010,  2017,   355,   7.9,  3,  "Brazil"   },
    {"Cory Joseph",           29,  true,    9,  2011,  2020,   592,   6.9,  4,  "Canada"   },
    {"David West",            40,  false,  15,  2003,  2018,  1034,  13.6,  4,  "America " },
    ...
    {"Kobe Bryant",           41,  false,  20,  1996,  2016,  1346,  25.0,  1,  "America"  },
    {"LeBron James",          35,  true,   17,  2003,  2020,  1258,  27.1,  3,  "America"  },
    {"Stephen Curry",         32,  true,   11,  2009,  2020,   699,  23.5,  1,  "America"  },
    {"Russell Westbrook",     31,  true,   12,  2008,  2020,   874,  23.2,  2,  "America"  },
    {"Kevin Durant",          31,  true,   12,  2007,  2020,   849,  27.0,  3,  "America"  },
    ...
    {"Rajon Rondo",           34,  true,   14,  2006,  2020,   873,  10.2,  6,  "America"  },
    {"Manu Ginobili",         42,  false,  16,  2002,  2018,  1057,  13.3,  1,  "Argentina"},
    {"Kyrie Irving",          28,  true,    9,  2011,  2020,   528,  22.4,  3,  "America"  },
    {"Vince Carter",          43,  true,   22,  1998,  2020,  1541,  16.7,  8,  "America"  },
    {"Carmelo Anthony",       35,  true,   17,  2003,  2020,  1114,  23.6,  5,  "America"  },
    {"Dwyane Wade",           38,  false,  16,  2003,  2019,  1054,  22.0,  3,  "America"  },
    ...
    {"Dirk Nowitzki",         41,  false,  21,  1998,  2019,  1522,  20.7,  1,  "Germany"  },
    {"Pau Gasol",             39,  false,  18,  2001,  2019,  1226,  17.0,  5,  "Spain"    },
    {"Marc Gasol",            35,  true,   12,  2008,  2020,   831,  14.7,  2,  "Spain"    },
    {"Grant Hill",            47,  false,  18,  1994,  2013,  1026,  16.7,  4,  "America"  },
    {"Ray Allen",             44,  false,  18,  1996,  2014,  1300,  18.9,  4,  "America"  },
    {"Klay Thompson",         30,  true,    8,  2011,  2019,   615,  19.5,  1,  "America"  },
    {"Kristaps Porzingis",    24,  true,    4,  2015,  2020,   237,  18.1,  2,  "Latvia"   },
    {"Shaquille O'Neal",      48,  false,  19,  1992,  2011,  1207,  23.7,  6,  "America"  },
    {"JaVale McGee",          32,  true,   12,  2008,  2020,   694,   7.9,  6,  "America"  },
    {"Dwight Howard",         34,  true,   16,  2004,  2020,  1106,  16.8,  6,  "America"  },
    {"Amare Stoudemire",      37,  false,  14,  2002,  2016,   846,  18.9,  4,  "America"  },
    {"Jason Kidd",            47,  false,  19,  1994,  2013,  1391,  12.6,  4,  "America"  },
...
std::vector<Serve> MockData::serve_ = {
    ...
    {"Tony Parker",           "Spurs",         2001, 2018, 17, 1198, 16.6},
    ...
    {"Marco Belinelli",       "Spurs",         2013, 2015,  2,  142, 11.4},
    ...
    {"Boris Diaw",            "Spurs",         2012, 2016,  4,  331,  8.7},
    {"Boris Diaw",            "Jazz",          2016, 2017,  1,   73,  4.6},
    {"Tiago Splitter",        "Spurs",         2010, 2015,  5,  311,  8.2},
    {"Tiago Splitter",        "Hawks",         2015, 2016,  1,   36,  5.6},
    {"Tiago Splitter",        "76ers",         2016, 2017,  1,    8,  4.9},
    {"Cory Joseph",           "Spurs",         2011, 2015,  4,  204,  4.5},
    ...
    {"David West",            "Warriors",      2016, 2018,  2,  141,  6.8},
    ...
    {"Kobe Bryant",           "Lakers",        1996, 2016, 20, 1346, 25.0},
    ...
    {"Stephen Curry",         "Warriors",      2009, 2020, 11,  699, 23.5},
    ...
    {"Rajon Rondo",           "Celtics",       2006, 2014,  9,  527, 11.9},
    ...
    {"Kyrie Irving",          "Cavaliers",     2011, 2017,  6,  381, 20.8},
    ...
    {"Carmelo Anthony",       "Nuggets",       2003, 2011,  8,  564, 25.2},
    ...
    {"Dwyane Wade",           "Heat",          2003, 2016, 13,  855, 26.6},
    ...
    {"Dirk Nowitzki",         "Mavericks",     1998, 2019, 21, 1522, 20.7},
    {"Pau Gasol",             "Grizzlies",     2001, 2008,  7,  476, 18.9},
    {"Pau Gasol",             "Lakers",        2008, 2014,  6,  429, 17.4},
    ...
    {"Marc Gasol",            "Raptors",       2019, 2020,  1,   62, 13.6},
    ...
    {"Ray Allen",             "Celtics",       2007, 2012,  5,  358, 16.5},
    {"Ray Allen",             "Heat",          2012, 2014,  2,  152, 10.9},
    {"Klay Thompson",         "Warriors",      2011, 2019,  8,  615, 19.5},
    ...
    {"Shaquille O'Neal",      "Lakers",        1996, 2004,  8,  514, 27.2},
    {"Shaquille O'Neal",      "Heat",          2004, 2008,  4,  205, 17.3},
    ...
    {"JaVale McGee",          "Warriors",      2016, 2018,  2,  142,  6.1},
    ...
    {"Jason Kidd",            "Mavericks",     1994, 1997,  3,  182, 11.7},
    {"Jason Kidd",            "Suns",          1997, 2001,  4,  313, 16.9},
    {"Jason Kidd",            "Nets",          2001, 2008,  7,  506, 13.3},
    {"Jason Kidd",            "Mavericks",     2008, 2012,  4,  318, 10.3},
...
std::shared_ptr<meta::SchemaProviderIf> MockData::mockPlayerTagSchema() {
    ...
    schema->addField(std::move(col10.name), std::move(col10.type));
...
std::vector<VertexData> MockData::mockVertices() {
    ...
    for (auto& player : players_) {
        ...
        v1.setStr(player.name_);
        props.push_back(v1);

        v2.setInt(player.age_);
        props.push_back(v2);

        v3.setBool(player.playing_);
        props.push_back(v3);

        v4.setInt(player.career_);
        props.push_back(v4);

        v5.setInt(player.startYear_);
        props.push_back(v5);

        v6.setInt(player.endYear_);
        props.push_back(v6);

        v7.setInt(player.games_);
        props.push_back(v7);

        v8.setFloat(player.avgScore_);
        props.push_back(v8);

        v9.setInt(player.serveTeams_);
        props.push_back(v9);

        v10.setStr(player.country_);
        props.push_back(v10);
...
std::vector<EdgeData> MockData::mockEdges() {
    ...
    for (auto& serve : serve_) {
        ...
        v1.setStr(serve.playerName_);
        props.push_back(v1);

        v2.setStr(serve.teamName_);
        props.push_back(v2);

        v3.setInt(serve.startYear_);
        props.push_back(v3);

        v4.setInt(serve.endYear_);
        props.push_back(v4);

        v5.setInt(serve.teamCareer_);
        props.push_back(v5);

        v6.setInt(serve.teamGames_);
        props.push_back(v6);

        v7.setFloat(serve.teamAvgScore_);
        props.push_back(v7);
...
std::vector<VertexData> MockData::mockVerticesSpecifiedOrder() {
    ...
    for (auto& player : players_) {
        ...
        v1.setStr(player.country_);
        props.push_back(v10);

        v2.setInt(player.serveTeams_);
        props.push_back(v2);

        v3.setFloat(player.avgScore_);
        props.push_back(v3);

        v4.setInt(player.games_);
        props.push_back(v4);

        v5.setInt(player.endYear_);
        props.push_back(v5);

        v6.setInt(player.startYear_);
        props.push_back(v6);

        v7.setInt(player.career_);
        props.push_back(v7);

        v8.setBool(player.playing_);
        props.push_back(v8);

        v9.setInt(player.age_);
        props.push_back(v9);

        v10.setStr(player.name_);
        props.push_back(v10);
...
std::vector<EdgeData> MockData::mockEdgesSpecifiedOrder() {
    ...
    for (auto& serve : serve_) {
        ...
        std::vector<Value>  props;
        Value v1, v2, v3, v4, v5, v6, v7;
        v1.setFloat(serve.teamAvgScore_);
        props.push_back(v1);

        v2.setInt(serve.teamGames_);
        props.push_back(v2);

        v3.setInt(serve.teamCareer_);
        props.push_back(v3);

        v4.setInt(serve.endYear_);
        props.push_back(v4);

        v5.setInt(serve.startYear_);
        props.push_back(v5);

        v6.setStr(serve.teamName_);
        props.push_back(v6);

        v7.setStr(serve.playerName_);
        props.push_back(v7);
...
MockData::mockAddVerticesSpecifiedOrder(int32_t parts) {
    ...
    for (auto& rec : retRecs) {
        ...
        newTag.set_props(std::move(row));
        if (rec.tId_ == 1) {
            std::vector<std::string> colNames{"country", "serveTeams", "avgScore", "games",
                                              "endYear", "startYear",  "career", "playing",
                                              "age", "name"};
